...
export class UI {
    ...
    public static Initialize(theme?: Partial<UITheme>): void {
        ...
        const kbmImage = Engine.LoadImage('assets/images/input/Keyboard_Mouse/Dark/T_Keyboard_Mouse_Key_Sprite.png');

        Renderer.DrawImage(kbmImage, new Vector2(0, 0), new Vector2(100, 100));

        console.log(kbmImage);

        Log.Trace('UI.Initialize() - UI initialized successfully.');
    }
