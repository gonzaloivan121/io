import { AlreadyInitializedError, InvalidArgumentError, NotFoundError, NotInitializedError } from '../../../errors';
...
export class Network {
    ...
    public static Initialize(options: NetworkSpecification = {}): void {
        ...
        Log.Trace('Network.Initialize() - Network initialized successfully.');
    }
