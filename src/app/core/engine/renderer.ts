...
export class Renderer {
    /**
     * Indicates whether the `Renderer` has been initialized with a valid canvas context.
     *
     * @private
     * @static
     * @type {boolean}
    ...
    /**
     * Gets the current width of the viewport in pixels.
     *
     * @readonly
     * @static
     * @type {number}
    ...
    /**
     * Gets the current height of the viewport in pixels.
     *
     * @readonly
     * @static
     * @type {number}
